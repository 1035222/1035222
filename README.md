...
Soy estudiante de Ingeniería Informática con interés particular en **ingeniería de software**: arquitectura limpia, buenas prácticas y el proceso completo de construcción de un producto, desde la base de datos hasta la interfaz.
...
![CORS](https://img.shields.io/badge/CORS-FF6C37?style=for-the-badge&logo=fastapi&logoColor=white)
...
<img src="https://komarev.com/ghpvc/?username=1035222&style=for-the-badge&color=7F3FBF"/>
...
## 🚀 Proyecto destacado: NOUSIA

Plataforma académica modular full-stack (React + Node.js/Express + MySQL), organizada por roles institucionales:

| Módulo | Rol | Función |
|--------|-----|---------|
| 🟢 **SONAR** | Estudiante | Notas, tareas, horarios y certificados |
| 🔵 **SAICO** | Docente | Grupos, asignaciones, entregas y calificaciones |
| 🟣 **ZAFIRO** | Administración / Soporte | Usuarios, roles, tickets, reportes y horarios |
